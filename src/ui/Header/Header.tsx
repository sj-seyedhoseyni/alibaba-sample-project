...
const Header = () => {
  const { mode, togglePaletteMode } = useTheme();

  return (
    <header className="sticky top-0 z-10 px-4 bg-app-paper shadow-lg py-6">
      <div className="container mx-auto">
        <div className="flex justify-between items-center">
          <div className="font-bold text-xl">Where in the world?</div>

          <button onClick={togglePaletteMode} className="flex items-center gap-2">
            {mode === "light" ? (
              <>
              ...
              <>
                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24" fill="#fafafa">
